	...
	if (NewState == DISABLE)	//¸Ä
  	{
    	GPIO_ResetBits(USB_DISCONNECT, USB_DISCONNECT_PIN);
  		...
  		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;	//¸Ä
...
//----USB·¢ËÍ------------------------------------------------------------------
bool usb_write(u8 *buff, vu16 lenth)
{
  UserToPMABufferCopy(buff, ENDP1_TXADDR, lenth);
  SetEPTxCount(ENDP1, lenth);
  SetEPTxValid(ENDP1);
}
